...
DEVICE_BASE=fhd
DEVICE=moorefield/$DEVICE_BASE
VENDOR=asus

OUTDIR=vendor/$VENDOR/$DEVICE
mkdir -p ../../../../$OUTDIR
MAKEFILE=../../../../$OUTDIR/$DEVICE_BASE-vendor-blobs.mk
...
(cat << EOF) > ../../../../$OUTDIR/$DEVICE_BASE-vendor.mk
# Copyright (C) 2014 The CyanogenMod Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
\$(call inherit-product, vendor/$VENDOR/$DEVICE/$DEVICE_BASE-vendor-blobs.mk)
EOF
